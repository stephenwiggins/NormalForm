...
class Factorial(unittest.TestCase):
    ...
    def test_values(self):
        self.assertEqual(Utility.factorial(0), 1)
        self.assertEqual(Utility.factorial(1), 1)
        self.assertEqual(Utility.factorial(2), 2)
        self.assertEqual(Utility.factorial(5), 120)
